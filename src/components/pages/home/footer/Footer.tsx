...
export const Footer = () => {
  ...
  return (
    <footer className="bg-black">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <Image
              ...
              height={36}
            />
            <p className="text-white mt-8 text-xs opacity-60">
          ...
          <div className="flex gap-6 flex-col">
            ...
            <div className="flex gap-2 items-center">
              ...
              <a href="#">
                <Image src={"/vectors/x.svg"} alt="X" width={36} height={36} />{" "}
              </a>
              <a href="#">
                <Image
      ...
      <div className="px-20 py-8 flex flex-wrap md:flex-nowrap gap-4 items-center">
        <Image
        ...
        <p className="text-white opacity-60 text-xs">
          Lorem ipsum dolor sit amet consectetur. Quis orci sit lectus mauris mi
          id justo. Sed ipsum tempus in eget. Dictum quis felis in id. Ante
          feugiat arcu aliquam tortor. Faucibus bibendum integer dui dolor nisl
          id egestas. In nisl imperdiet auctor felis. Velit libero consectetur
          sed nisl.{" "}
        </p>
        <a
          href="#"
